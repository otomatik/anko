...
```gradle
dependencies {
    compile 'org.jetbrains.anko:anko-sdk15:0.7.4' // sdk19, sdk21, sdk23 are also available
    compile 'org.jetbrains.anko:anko-support-v4:0.7.4' // In case you need support.v4 bindings
}
```
